...
public class TaskAllocatorMinMaxUsingEdmondKarp 
{
	...
	public static void createInputData() throws IOException
	{
		...
		try {
			taskFileContent = new BufferedReader(new FileReader("C:\\Users\\kushr\\eclipse-workspace\\EdmondKarp\\src\\out\\production\\Project\\TaskList.txt"));
		...
		try {
			workerFileContent = new BufferedReader(new FileReader("C:\\Users\\kushr\\eclipse-workspace\\EdmondKarp\\src\\out\\production\\Project\\worker.txt"));
		} catch (FileNotFoundException e) {
		...
		File output = new File("C:\\Users\\kushr\\eclipse-workspace\\EdmondKarp\\src\\out\\production\\Project\\task.txt");
		PrintWriter writer = new PrintWriter(new FileWriter(output, false));
